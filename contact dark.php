...
<html lang="en">
    ...
    <body>
        <header class="header">
            <nav class="nav">
            <ul class="nav-list">
                <li><a href="contact.php" class="darkmode-change"><img src="static/images/darkmode.png" alt="Light" class="darkmodeimg"></a></li>
                <?php
                ...
                ?>
                <li><a href="contact_nl dark.php" class="language-change">NL</a></li>
            </ul>
            </nav>
        </header>
