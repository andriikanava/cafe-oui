...
<body>
    <div class="mainGrid">
        <header class="header">
            <nav class="nav">
            <ul class="nav-list">
                <li><a href="home_nl.php" class="darkmode-change"><img src="static/images/lightmode.png" alt="Light" class="darkmodeimg"></a></li>
                <?php
                ...
                ?>
                <li><a href="home_nl.php" class="language-change">EN</a></li>
            </ul>
            </nav>
        </header> 
        <div class="mainImg">
