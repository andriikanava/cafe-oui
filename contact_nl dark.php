...
<html lang="en">
    ...
    <body>
        <header class="header">
            <nav class="nav">
            <ul class="nav-list">
                <li><a href="contact_nl.php" class="darkmode-change"><img src="static/images/lightmode.png" alt="Dark" class="darkmodeimg"></a></li>
                <?php
                ...
                ?>
                <li><a href="contact dark.php" class="language-change">NL</a></li>
            </ul>
            </nav>
        </header>
