...
$navigationLink=array("home dark_nl.php", "about_us dark.php", "menu dark.php", "contact dark.php", "Impressions dark.php");
?>
...
<body>
    <header class="header">
        <nav class="nav">
        <ul class="nav-list">
            <li><a href="menu_nl.php" class="darkmode-change"><img src="static/images/darkmode.png" alt="Light" class="darkmodeimg"></a></li>
            <?php
            ...
            ?>
             <li><a href="menu dark.php" class="language-change">EN</a></li>
        </ul>
        </nav>
    </header>
